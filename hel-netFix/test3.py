...
from PyQt5.QtWidgets import (
    ...
    QProgressDialog # Added for progress indication
)
...
class NetFixApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setFixedSize(500, 750) # Adjusted size to accommodate more buttons
    ...
    def run_command(self, command):
        ...
        sensitive_commands = [
            ...
            "sudo pacman -Qqn | xargs sudo pacman -S" # Reinstalling packages
        ]
